...
$zenflow_yoga_section_one = get_theme_mod( 'zenflow_yoga_section_blog_post_enable' );
...
<section id="section1" class="featured-posts">
  <div class="post-section-class">
    <div class="heading-class">
        <h3><?php echo esc_html(get_theme_mod('zenflow_yoga_section_blog_post_title')); ?></h3>
    </div>
    <div class="row">
      <div class="col-lg-12 col-12">
          <div class="row">
            <?php
              ...
              $args = array(
                'category_name' =>  get_theme_mod('zenflow_yoga_section_blog_post_category'),
                'posts_per_page' => get_theme_mod('zenflow_yoga_section_blog_post_category_number'),
                'order' => 'DESC'
              );
